...
%%
%%% path of directory 
files = dir("./rawdata/20200914/*.xlsx");
%for i = 1:length(files)
 
  for i = 15
%     read experiment rawdata
    xfileplace = ["rawdata/20200914/", files(i).name];
...
%%%%%%%%
    ...
    lat_aft = data.LatitudeDeg_3(:)+data.LatitudeMin_3(:)/60;
    lon_aft = data.LongitudeDeg_3(:)+data.LongitudeMin_3(:)/60;
        
    lat_3 = data.LatitudeDeg_Aft(:)+data.LatitudeMin_Aft(:)/60;
    lon_3 = data.LongitudeDeg_Aft(:)+data.LongitudeMin_Aft(:)/60;
